...
protocol MotionAccessLayoutViewLogic: AnyObject {
	func giveAccessButtonPressed()
	func laterButtonPressed()
}

class MotionAccessLayoutView: FontChangeView {
	...
	weak var controller: MotionAccessLayoutViewLogic?
	...
	func setup() {
		Bundle.main.loadNibNamed("MotionAccessLayoutView", owner: self, options: nil)
		addSubview(baseView)
		...
		imageView.image = UIImage.init(named: "motion_image")
		...
		titleLabel.text = "intro_motion_title".localized()
		descriptionLabel.text = "intro_motion_description".localized()
