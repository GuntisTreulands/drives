//
//  MotionAccessViewController.swift
//  GPS Tracker
//
...
protocol MotionAccessDisplayLogic: AnyObject {
}

class MotionAccessViewController: UIViewController, MotionAccessDisplayLogic, MotionAccessLayoutViewLogic {
  	var interactor: MotionAccessBusinessLogic?
	var layoutView: MotionAccessLayoutView!
	...
	private func setup() {
		...
		let interactor = MotionAccessInteractor()
		viewController.interactor = interactor
  	}

	private func setUpView() {
		layoutView = MotionAccessLayoutView(frame: CGRect(x: 0, y: 0, width: self.view.frame.width, height: 100))
  	...
  	func giveAccessButtonPressed() {
		interactor?.userAskedForMotionAccess()
  	}
